...
Enhanced version with new router setup, dependency checks, and legacy cleanup.
"""
...
from app.core.app_factory import setup_core_endpoints, lifespan
...
def create_app() -> FastAPI:
    ...
    # Static files and core endpoints
